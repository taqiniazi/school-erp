                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="POST" action="{{ route('transport.drivers.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="phone" class="mt-1 block w-full border rounded px-3 py-2">
                        </div>
                        <div class="mb-4">
                            <label class="block text-sm font-medium text-gray-700">License Number</label>
                            <input type="text" name="license_number" class="mt-1 block w-full border rounded px-3 py-2">
                        </div>
                        <div class="mb-6">
