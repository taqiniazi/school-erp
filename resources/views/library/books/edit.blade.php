            ...
            <div class="col-md-8">
                <div class="card shadow">
                    <div class="card-header py-3">
                        <h6 class="m-0 fw-bold text-primary">Edit Book Details</h6>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('library.books.update', $book) }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" name="copies_total" min="0" value="{{ $book->copies_total }}" class="form-control" required>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Shelf</label>
                                <input type="text" name="shelf" value="{{ $book->shelf }}" class="form-control">
                            </div>
                            <div class="mb-3">
