                    ...
                    <form method="POST" action="{{ route('inventory.returns.store') }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="date" name="return_date" class="border rounded w-full py-2 px-3" required>
                            </div>
                            <div>
                                <label class="block text-gray-700 text-sm font-bold mb-2">Reference</label>
                                <input name="reference" class="border rounded w-full py-2 px-3">
                            </div>
                            <div class="md:col-span-2">
                        ...
                        <div class="flex items-center justify-between mt-4">
                            ...
                            <a href="{{ route('inventory.returns.index') }}" class="text-blue-600 hover:text-blue-800">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
