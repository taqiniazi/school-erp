                ...
                <div class="card-body p-4">
                    <form method="POST" action="{{ route('inventory.returns.store') }}">
                        ...
                        <div class="row row-cols-1 row-cols-md-2 g-3">
                            ...
                            <div>
                                <label class="d-block text-dark small fw-bold mb-2">Return Date</label>
                                <input type="date" name="return_date" class="form-control" required>
                            </div>
                            <div>
                                <label class="d-block text-dark small fw-bold mb-2">Reference</label>
                                <input name="reference" class="form-control">
                            </div>
                            <div class="col-md-12">
                                <label class="d-block text-dark small fw-bold mb-2">Reason</label>
