            ...
            <div class="col-md-8">
                <div class="card shadow">
                    <div class="card-header py-3">
                        <h6 class="m-0 fw-bold">Edit Department</h6>
                    </div>
                    <div class="card-body">
                        @if ($errors->any())
                        ...
                        <form action="{{ route('departments.update', $department) }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="description" id="description" value="{{ old('description', $department->description) }}" class="form-control">
                            </div>
