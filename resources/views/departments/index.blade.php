<x-app-layout>
    <x-slot name="header">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
            <h1 class="h3 fw-bold text-dark mb-0">Departments</h1>
                    ...
                    <table class="table table-hover w-100 mb-0">
                        ...
                        <tbody>
                            @forelse ($departments as $department)
                                <tr>
                                    <td class="p-3 text-nowrap">{{ $department->name }}</td>
                            ...
                            @empty
                                <tr>
                                    <td colspan="4" class="p-3 text-center text-secondary">No departments found.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
