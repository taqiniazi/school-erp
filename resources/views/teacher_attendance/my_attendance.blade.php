...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route('teacher.my-attendance') }}" method="GET" class="row g-3 mb-4">
            <div class="col-md-3">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            @for($i = 1; $i <= $daysInMonth; $i++)
                                ...
                                @endphp
                                <tr>
                                    <td>{{ date('d-m-Y (D)', strtotime($date)) }}</td>
                                    <td class="{{ $color }}">{{ ucfirst(str_replace('_', ' ', $status)) }}</td>
            ...
            <div class="col-md-4">
                <div class="card">
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            Leave
                            <span class="badge bg-primary rounded-pill">{{ $attendances->where('status', 'leave')->count() }}</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            Total Working Days
