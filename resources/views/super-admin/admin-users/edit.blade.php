...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Edit School Admin</h1>
        ...
        <div class="col-lg-8">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Edit Details: {{ $adminUser->name }}</h6>
                </div>
                <div class="card-body">
                    @if ($errors->any())
                    ...
                    <form method="POST" action="{{ route('super-admin.admin-users.update', $adminUser->id) }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <h5 class="mb-3 text-gray-800">Admin Information</h5>
                                <div class="mb-3">
