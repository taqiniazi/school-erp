...
<div class="container-fluid">
    <div class="d-sm-d-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-dark">Edit Plan</h1>
        ...
        <div class="col-lg-8">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 fw-bold text-primary">Edit Plan: {{ $plan->name }}</h6>
                </div>
                <div class="card-body">
                    <form action="{{ route('super-admin.plans.update', $plan) }}" method="POST">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" class="form-control @error('max_teachers') is-invalid @enderror" id="max_teachers" name="max_teachers" value="{{ old('max_teachers', $plan->max_teachers) }}">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" class="form-control @error('max_campuses') is-invalid @enderror" id="max_campuses" name="max_campuses" value="{{ old('max_campuses', $plan->max_campuses) }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('storage_limit_mb') is-invalid @enderror" id="storage_limit_mb" name="storage_limit_mb" value="{{ old('storage_limit_mb', $plan->storage_limit_mb) }}">
                                ...
                                @foreach($modules as $key => $label)
                                    <div class="col-md-4 mb-2">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="allowed_modules[]" value="{{ $key }}" id="module_{{ $key }}" 
                                                {{ in_array($key, old('allowed_modules', $plan->allowed_modules ?? [])) ? 'checked' : '' }}>
