                    ...
                    <form action="{{ route('accounting.income.update', $income) }}" method="POST">
                        ...
                        <div class="row row-cols-1 row-cols-md-2 g-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" name="date" value="{{ $income->date->format('Y-m-d') }}" class="form-control" required>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="category" value="{{ $income->category }}" class="form-control">
                            </div>
                            ...
                            <div class="mb-3 col-12">
                                ...
                                <input type="text" name="reference" value="{{ $income->reference }}" class="form-control">
                            </div>
                        </div>
                        <div class="d-flex align-items-center justify-content-between mt-4">
                            ...
                            <a href="{{ route('accounting.income.index') }}" class="btn btn-link text-decoration-none text-secondary">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
