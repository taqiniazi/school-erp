        ...
        <div class="card shadow-sm border-0 rounded-3">
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    <h5 class="card-title mb-0 fw-bold"><i class="fas fa-user-plus me-2"></i>Add Teacher</h5>
                    <a href="{{ route('teachers.index') }}" class="btn btn-outline-light"><i class="fa fa-arrow-left"></i> Back</a>
                </div>
            </div>
            <div class="card-body p-4">
                <form action="{{ route('teachers.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <button type="submit" class="btn btn-primary btn-lg">Create Teachers</button>
                </form>
            </div>
        </div>
    </div>
...
@push('scripts')
<script>
    function initTeacherCreateRows() {
        ...
        function setIndexForRow(row, idx) {
        ...
        function renumberRows() {
            ...
            rows.forEach((row, idx) => setIndexForRow(row, idx));
        }
    ...
    document.addEventListener('DOMContentLoaded', initTeacherCreateRows);
    initTeacherCreateRows();
</script>
@endpush